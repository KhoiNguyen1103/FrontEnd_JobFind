        ...
        <div className="bg-white shadow-md rounded-lg p-6 mb-6 flex items-center justify-between border-b">
          ...
          <div>
            ...
            >
              <FontAwesomeIcon
                icon={faMessage}
                className="h-5 w-5 text-blue-600 cursor-pointer hover:text-blue-700 transition"
              />
            </button>
          </div>
        </div>
                ...
                .map((experience, index) => (
                  ...
                  >
                    ...
                    <p className="text-gray-500 text-base">
                      ...
                      {experience.endDate ? experience.endDate : "Hiện tại"} •{" "}
                      {calculateDuration(
                        experience.startDate,
                        experience.endDate
                      )}
                    </p>
                    <p className="text-gray-600 text-base mt-1 italic">
