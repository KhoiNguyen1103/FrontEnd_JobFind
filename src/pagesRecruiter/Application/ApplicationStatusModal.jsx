...
const ApplicationStatusModal = ({
  ...
  const handleClickProfileDetailButton = () => {
    if (application.jobSeekerProfile?.profileId) {
      navigate(`/job-seeker-profile/${application.jobSeekerProfile.profileId}`);
    } else {
      console.error(
        "Profile ID is undefined or invalid",
      ...
      >
        ...
        <div className="mb-8">
          ...
          <div className="mt-4">
            ...
            <select
              onChange={(e) =>
                handleUpdateStatus(application.applicationId, e.target.value)
              }
            ...
            >
              ...
              {getAvailableStatuses(
                application.statusDTOList[application.statusDTOList.length - 1]
                  ?.status
              ).map((status) => (
          ...
          <div className="bg-gray-100 rounded-xl p-6 shadow-md hover:shadow-lg transition">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Lương: {application.job.salaryMin / 1000000} -{" "}
                  {application.job.salaryMax / 1000000}
                </p>
                <p className="text-gray-600">
                  Địa điểm: {application.job.location}
                </p>
                <p className="text-gray-600">
                  Hình thức: {application.job.jobType}
                </p>
                <p className="text-gray-600">
                  Hạn chót: {formatDate(application.job.deadline)}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    {application.jobSeekerProfile.title}
                  </p>
                </div>
              </div>
              <div>
              ...
              <div>
                ...
                {application.jobSeekerProfile.workExperiences.length > 0 ? (
                  application.jobSeekerProfile.workExperiences.map(
                    (exp, index) => (
                      <div
                        key={index}
