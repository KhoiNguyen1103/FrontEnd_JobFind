...
const ApplicationModalJSK = ({
  ...
  useEffect(() => {
    ...
    const fetchApplication = async () => {
      ...
      setError(null);
      try {
        const response = await applicationApi.getApplicationHistory(
          applicationId
        );
      ...
      >
        ...
        {loading ? (
          ...
          <div className="text-center py-8">
            Không có dữ liệu đơn ứng tuyển.
          </div>
        ) : (
          <>
            <div className="mb-8">
              ...
              <div className="bg-gray-100 rounded-xl p-6 shadow-md hover:shadow-lg transition">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Ngành:{" "}
                      {application.job.company.industry[0]?.name || "N/A"}
                    </p>
                    <a
                  ...
                  <div>
                    ...
                    <div
                      className="text-gray-600 prose max-w-none"
                      dangerouslySetInnerHTML={{
                        __html: application.job.benefits || "",
                      }}
                    />
                  </div>
                  <div>
                    ...
                    <p className="text-gray-600">
                      Địa điểm: {application.job.location || "N/A"}
                    </p>
                    <p className="text-gray-600">
                      Hình thức: {application.job.jobType || "N/A"}
                    </p>
                    <p className="text-gray-600">
              ...
              <div className="bg-gray-100 rounded-xl p-6 shadow-md hover:shadow-lg transition">
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-4">
                    <img
                      src={
                        application.jobSeekerProfile?.avatar ||
                        "/default-avatar.png"
                      }
                      alt={`${application.jobSeekerProfile?.firstName || ""} ${
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Số điện thoại:{" "}
                      {application.jobSeekerProfile?.phone || "N/A"}
                    </p>
                    <p className="text-gray-600">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {application.jobSeekerProfile?.skills?.length > 0 ? (
                        application.jobSeekerProfile.skills.map(
                          (skill, index) => (
                            <span
                              key={index}
                              className="bg-blue-100 text-blue-800 text-sm px-3 py-1 rounded-full"
                  ...
                  <div>
                    ...
                    {application.jobSeekerProfile?.workExperiences?.length >
                    0 ? (
